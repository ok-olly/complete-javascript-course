...
// Methods
console.log(restaurant.order?.(0, 1) ?? 'Method does not extis');
console.log(restaurant.orderRisotto?.(0, 1) ?? 'Method does not extis');
...
console.log(ordersSet.size); // How many different food
...
console.log(maskCreditCard(1234888812349999));
console.log(maskCreditCard('9999888812347777'));
